...
class MarketBeautyPresenter: MarketBeautyContract.Presenter {

    private lateinit var view: MarketBeautyContract.View
    ...
    override fun setView(view: MarketBeautyContract.View, context: Context) {
        this.view = view
    ...
    override fun setUpData() {
        ...
        disposable = apiClient.bringMarket(3, pageNumber)
