...
class MarketTicketPresenter: MarketTicketContract.Presenter {

    private lateinit var view: MarketTicketContract.View
    ...
    override fun setView(view: MarketTicketContract.View, context: Context) {
        this.view = view
    ...
    override fun setUpData() {
        ...
        disposable = apiClient.bringMarket(5, pageNumber)
