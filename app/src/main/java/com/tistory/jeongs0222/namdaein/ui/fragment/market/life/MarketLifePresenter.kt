...
class MarketLifePresenter: MarketLifeContract.Presenter {

    private lateinit var view: MarketLifeContract.View
    ...
    override fun setView(view: MarketLifeContract.View, context: Context) {
        this.view = view
    ...
    override fun setUpData() {
        ...
        disposable = apiClient.bringMarket(7, pageNumber)
