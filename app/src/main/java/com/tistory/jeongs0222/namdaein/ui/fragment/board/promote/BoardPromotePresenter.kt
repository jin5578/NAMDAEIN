...
class BoardPromotePresenter: BoardPromoteContract.Presenter {

    private lateinit var view: BoardPromoteContract.View
    ...
    override fun setView(view: BoardPromoteContract.View, context: Context) {
        this.view = view
    ...
    override fun setUpData(loadValue: Int) {
        ...
        disposable = apiClient.bringBoard(2, pageNumber)
