...
import com.tistory.jeongs0222.namdaein.ui.fragment.market.merchandise.MarketMerchandiseContract
import io.reactivex.android.schedulers.AndroidSchedulers
import io.reactivex.disposables.Disposable
import io.reactivex.schedulers.Schedulers


class MarketStudioPresenter: MarketStudioContract.Presenter {

    private lateinit var view: MarketStudioContract.View
    ...
    override fun setView(view: MarketStudioContract.View, context: Context) {
        this.view = view
    ...
    override fun setUpData() {
        ...
        disposable = apiClient.bringMarket(8, pageNumber)
